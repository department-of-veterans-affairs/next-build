...
export function VamcSystemDetailPage({ entityPath, title, introText, showTableOfContents, menu, lovellVariant, lovellSwitchPath, relatedLinks, lastUpdated }: LovellStaticPropsResource<FormattedVamcSystemDetailPage>) {
  ...
  return (
    ...
    >
      ...
      {isContactPage && (
        <div>TODO: Social links component</div>
      )}
