...
import {
  createBillingAndInsuranceServiceQueryMocks,
  mockBillingAndInsuranceServices,
...
describe('VamcSystemBillingAndInsurance formatter', () => {
  ...
  test('sorts services alphabetically by title', async () => {
    const unsortedServices = [
      {
        ...mockBillingAndInsuranceServices[0],
        field_facility_location: {
          ...mockBillingAndInsuranceServices[0].field_facility_location,
