...
export function CampaignLandingPage({ title }: CampaignLandingPageProps) {
  // TODO: Resolve these placeholders
  const placeholders = {
    // Hero section
  ...
  return (
    <div
      id="content"
      className="interior"
      data-template="node-campaign_landing_page"
    >
      <main>
              ...
              <div className="vads-u-display--flex small-desktop-screen:vads-l-row">
                ...
                <div className="vads-u-display--none desktop:vads-u-display--block">
                  <img
                    alt=""
                    src={
                      placeholders.fieldHeroImage.entity.image.derivative.url
                    }
                  />
                </div>
              </div>
              ...
              >
                <div className="vads-u-background-color--gray-light-alt vads-u-height--full medium-screen:vads-u-margin-x--1 medium-screen:vads-u-margin-y--0">
                  <img
                    ...
                    src={
                      promo.entity.fieldImage.entity.thumbnail.derivative.url
                    }
                    width={
                ...
                <div className="vads-l-row">
                  <div className="vads-u-col--12">
                    <va-link-action
                      ...
                      type="secondary"
                      text={
                        placeholders.fieldClpResourcesCta.entity
                          .fieldButtonLabel
                      }
                    />
                  </div>
