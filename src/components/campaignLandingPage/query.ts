...
export const data: QueryData<CampaignLandingPageDataOpts, NodeCampaignLandingPage> = async (
  opts
): Promise<NodeCampaignLandingPage> => {
...
export const formatter: QueryFormatter<NodeCampaignLandingPage, CampaignLandingPage> = (
