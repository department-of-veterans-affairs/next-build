...
describe('MobileNavTrigger', () => {
  ...
  //     const wrapper = container.querySelector('.va-btn-sidebarnav-trigger')
  ...
  //     const sentinel = wrapper?.querySelector('.sidenav-trigger-sentinel')
  //     expect(sentinel).toBeInTheDocument()

  //     const trigger = wrapper?.querySelector('#sidenav-trigger')
  //     expect(trigger).toBeInTheDocument()
  ...
  //     // This tests that the component doesn't crash if refs are null
  //     // The useEffect should check for refs before using them
  //     const { unmount } = render(<MobileNavTrigger onToggle={mockOnToggle} />)
  ...
  //   it('handles onToggle being called multiple times rapidly', () => {
  //     render(<MobileNavTrigger onToggle={mockOnToggle} />)
