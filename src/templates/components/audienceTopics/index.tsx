...
export function AudienceTopics({
  ...
  const tagsList = tags.map(({ id, href, name }, index) => (
    <Link
      href={href}
      key={id}
      className="vads-u-margin-bottom--1p5 usa-button-secondary vads-u-font-size--sm vads-u-border--1px vads-u-border-color--primary vads-u-padding-y--0p25 vads-u-padding-x--0p5 vads-u-margin-left--1p5 vads-u-text-decoration--none vads-u-color--base"
