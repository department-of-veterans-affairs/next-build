...
export const ImageAndStaticMap: React.FC<ImageAndStaticMapProps> = ({
  ...
  return (
    <div
      className="usa-width-one-third inline-table-helper vads-u-order--first small-screen:vads-u-order--initial vads-u-margin-bottom--2 vads-u-margin-left--auto facility"
