...
describe('PhoneNumber Component', () => {
  const createPhoneData = (extension, label, number, numberType): FormattedPhoneNumber => ({
    extension,
    id: 'cb689f5e-c51e-4ef7-8d61-254cb6f19269',
    label,
    number,
    numberType,
  ...
  describe('standard phone numbers', () => {
    test('renders the phone number correctly with given extension', () => {
      const phoneWithExtension = createPhoneData('1234', 'Phone', '123-456-7890', 'phone')
      const { container } = render(
        <PhoneNumber {...phoneWithExtension} />
      )
    ...
    test('renders the phone number correctly with a nested extension', () => {
      const phoneWithNestedExtension = createPhoneData('', 'Phone', '098-765-4321 ext. 4321', 'phone')
      const { container } = render(
    ...
    test('renders the phone number correctly with a nested extension', () => {
      const phoneNoDashesNestedExt = createPhoneData('', 'Phone', '5666998784 x87387', 'phone')
      const { container } = render(
        <PhoneNumber {...phoneNoDashesNestedExt} />
      )
