...
export function FeaturedContent({
  ...
  return (
    <div className="featured-content-list-item vads-u-flex--fill vads-u-padding-y--1p5 vads-u-padding-x--1p5 vads-u-margin-bottom--0 medium-screen:vads-u-margin-bottom--2">
      {title && (
        <>
