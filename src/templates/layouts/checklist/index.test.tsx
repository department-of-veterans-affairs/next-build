...
describe('Checklist with valid data', () => {
  ...
  test('renders Checklist component', () => {
    const { container } = render(
      <Checklist id="" type="" published={false} {...data} />
    )
    ...
    // Tags
    expect(
      screen.getByText('Fraud and identity theft prevention')
    ).toBeInTheDocument()
    ...
    expect(container.innerHTML).toContain('888-GIBILL-1 (888-442-4551)')
    expect(container.innerHTML).toContain('+1-918-781-5678')
