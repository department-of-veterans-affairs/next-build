...
const meta: Meta<typeof VetCenterOutstation> = {
  title: 'Layouts/VetCenterOutstation',
  component: VetCenterOutstation,
}
export default meta

type Story = StoryObj<typeof VetCenterOutstation>
