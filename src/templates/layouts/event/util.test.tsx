import { formatDateObject, deriveMostRecentDate, deriveFormattedTimestamp, isEventInPast } from './util';

describe('Util functions', () => {

  describe('formatDateObject', () => {
    it('should add startTime, endTime, value, and endValue to each date object', () => {
      const datetimeRange = [{ value: new Date('2023-09-07T14:00:00Z'), end_value: new Date('2023-09-07T16:00:00Z') }];
  ...
  describe('deriveFormattedTimestamp', () => {
    it('should correctly format the event timestamp', () => {
      const datetime = { startTime: new Date('2023-09-07T14:00:00Z'), endTime: new Date('2023-09-07T16:00:00Z') };
