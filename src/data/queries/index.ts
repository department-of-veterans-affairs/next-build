...
import * as HealthCareLocalFacility from '@/products/healthCareLocalFacility/query'
import * as LinkTeaser from '@/data/queries/linkTeaser'
import * as LocationsListing from '@/products/locationsListing/query'
...
import * as NewsStory from '@/products/newsStory/query'
...
import * as QuestionAnswer from '@/products/questionAnswer/query'
import * as ReactWidget from '@/data/queries/reactWidget'
import * as ResourcesSupport from '@/products/resourcesSupport/query'
...
import * as VamcSystem from '@/products/vamcSystem/query'
import * as VamcSystemVaPolice from '@/products/vamcSystemVaPolice/query'
import * as VetCenter from '@/products/vetCenter/query'
import * as VetCenterHealthServices from '@/data/queries/vetCenterHealthServices'
import * as VetCenterOutstation from '@/products/vetCenterOutstation/query'
