...
import { Meta as NewsStoryMeta } from 'templates/news_story/dataService'
import { Meta as StoryListingMeta } from 'templates/story_listing/dataService'
import { Meta as PersonProfileMeta } from 'templates/person_profile/dataService'
import { Meta as AlertBlockMeta } from 'templates/alert/dataService'
import { Meta as WysiwygMeta } from 'templates/wysiwyg/dataService'
import { Meta as ExpandableTextMeta } from 'templates/expandable_text/dataService'
import { Meta as MediaImageMeta } from 'templates/media/dataService'
import { Meta as AudienceTopicsMeta } from 'templates/audience_topics/dataService'
import { Meta as LinkTeaserMeta } from 'templates/linkTeaser/dataService'
import { Meta as ButtonMeta } from 'templates/button/dataService'
import { Meta as EmailContactMeta } from 'templates/email_contact/dataService'
import { Meta as StaffProfileMeta } from 'templates/staffProfile/dataService'
import { Meta as RichTextCharLimit1000Meta } from 'templates/richTextCharLimit1000/dataService'
import { Meta as QuestionAnswerMeta } from 'templates/questionAnswer/dataService'
