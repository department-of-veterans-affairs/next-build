...
export interface NodeCampaignLandingPage extends DrupalNode {
  ...
  field_hero_image: InternalDrupalTarget
  field_primary_call_to_action: InternalDrupalTarget
  field_secondary_call_to_action: InternalDrupalTarget | null
  ...
  field_clp_faq_paragraphs: InternalDrupalTarget[]
  ...
  field_benefit_categories: InternalDrupalTarget[]
  field_clp_audience: InternalDrupalTarget[]
