...
/**
 * Checks if a user agent is a bot based on Datadog's documentation
 *
 * @param agent - Call with navigator.userAgent
 * @returns true if the user agent is a known bot, false otherwise
 */
export const isBot = (agent: string) => botRegex.test(agent)
