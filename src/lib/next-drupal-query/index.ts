/**
 * Originally from next-drupal-query (https://github.com/chapter-three/next-drupal)
 * MIT License - Copyright (c) 2021 Chapter Three
 *
 * This software is incorporated into the project as the upstream package is no longer maintained.
 * See the full license: https://github.com/chapter-three/next-drupal/blob/main/packages/next-drupal-query/LICENSE
 */
