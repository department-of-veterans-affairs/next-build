...
import { getSitemapLocations, splitPagesIntoSegments } from '../playwright/utils/getSitemapLocations.js';
import fs from 'fs'
...
async function checkBrokenLinks() {
  ...
  console.log(`Splitting page list into ${chalk.yellow(BATCH_SIZE)} batches for processing.`)
  ...
  console.log(`Scanned total of ${chalk.yellow(linksChecked.length)} links on ${chalk.yellow(pagesChecked.length)} pages!`);
